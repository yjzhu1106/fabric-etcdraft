...
echo "SYS_CHANNEL=${SYS_CHANNEL}"
echo "CONN_CONF_PATH=${CONN_CONF_PATH}"
...
echo "========= All GOOD, [orgs, block, channel, Org1MSP, Org2MSP] execution completed =========== "
